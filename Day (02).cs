...
//{
//    var gameNumber = int.Parse(line.Split(":")[0].Replace("Game ", ""));
//    var handfuls = line.Split(":")[1].Split(";");
//    var maxBalls = new Dictionary<string, int>
//        {
//            {"red", 0 },
//            {"green", 0 },
//            {"blue", 0 }
...
//        var ballsByColorList = handful.Split(",").Select(x => x.TrimStart().TrimEnd().Split(" ")).Select(x => new { count = int.Parse(x[0]), color = x[1] });
//        foreach (var ballsByColor in ballsByColorList)
//        {
//            maxBalls[ballsByColor.color] = Math.Max(maxBalls[ballsByColor.color], ballsByColor.count);
//        }
//    }
